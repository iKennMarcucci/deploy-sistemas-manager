          ...
          opcion.subopciones ? (
              ...
              {opcion.subopciones.map((sub, subIndex) => (
                ...
                >
                  <Link
                    ...
                    to={sub.href}
                    onClick={(e) =>
                      handleNavigate(e, sub.href, sub.label, sub.codigo)
                    }
                    className={`block pt-1 pl-4 text-negro-institucional rounded-md transition-colors duration-300 ease-in-out truncate max-w-full ${
            ...
            >
              <Link
                key={index}
                to={opcion.href}
                onClick={(e) => handleNavigate(e, opcion.href, opcion.label)}
                className={`block pt-1 pl-6 text-negro-institucional rounded-md transition-colors duration-300 ease-in-out truncate ${
